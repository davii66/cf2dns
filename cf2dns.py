...
#修改需要更改的dnspod域名核子域名
DOMAINS = {
    "b.davi.fun": {"@": ["CM","CU","CT"], "shop": ["CM", "CU", "CT"], "stock": ["CM","CU","CT"]},
    "d.davi.fun": {"@": ["CM","CU","CT"], "vv": ["CM","CU","CT"]}
}
...
SECRETID = 'LTAI4GEyocZetW1HPgNu12GA'
SECRETKEY = 'BvnLujzimO6lJQ65Ux9v46LpsTXgdZ'
